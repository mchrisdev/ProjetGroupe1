            ...
            <div>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-6">
                     <div class="card">
                        <div class="card-header">
                           <h5 class="card-header-text">Textual Inputs</h5>
                           <div class="f-right">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-6">
                     <div class="card">
                        <div class="card-header">
                           <h5 class="card-header-text">Validation with Helper</h5>
                           <div class="f-right">
                  ...
                  <div class="col-lg-6">
                     <div class="card">
                        <div class="card-header">
                           <h5 class="card-header-text"> Validation</h5>
                           <div class="f-right">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-6">
                     <div class="card">
                        <div class="card-header">
                           <h5 class="card-header-text">Basic Form</h5>
                           <div class="f-right">
                  ...
                  <div class="col-lg-6">
                     <div class="card">
                        ...
                        <div class="card-block">
                           ...
                           <p class="m-b-20">
                              Bootstrap4 dropped the <code>.form-horizontal</code> class requirement.so we not need to add <code>.form-horizontal</code>class ..form-group no longer applies styles from the <strong>.row</strong> via mixin, so <strong>.row</strong>                              is now required for horizontal grid layouts
                           </p>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-12 inline-forms">
                     <div class="card">
                        <div class="card-header">
                           <h5 class="card-header-text">Inline Form</h5></div>
                        <div class="card-block">
                           <p class="m-b-20">
                           ...
                           <div class="card inline-form-style inline-form-1">
                              <div class="card-header">
                                 <h5 class="card-header-text">Hidden labels</h5>
                                 <div class="f-right">
                           ...
                           <div class="card inline-form-style inline-form-2">
                              <div class="card-header">
                                 <h5 class="card-header-text">Inline labels</h5>
                                 <div class="f-right">
                           ...
                           <div class="card inline-form-style">
                              <div class="card-header">
                                 <h5 class="card-header-text">Form groups</h5>
                                 <div class="f-right">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header">
                           <h5 class="card-header-text">Input Groups & Addon</h5>
                           <div class="f-right">
